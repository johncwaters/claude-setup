...
- `setup/`: everything beyond Claude Code
  ...
  - `repos.txt`: project repos referenced by glissa sessions (milepost, glissa, keeplings, card-harbor); apply clones missing ones into `~/Projects` and fast-forwards existing ones
